...
ADCMT 7461A は USB/GPIB の両方で使える ADCMT command language で制御します。
...
The ADCMT 7461A is controlled with the ADCMT command language so the same driver can be used over USB and GPIB.
