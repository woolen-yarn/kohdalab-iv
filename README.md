...
The current development version is `0.2.2`. It includes simulated end-to-end measurements, configuration preflight validation, provenance-rich CSV output, GUI run-state protection, cross-platform Python 3.13 CI, release-artifact verification, and 100% statement and branch coverage.
