# KohdaLab IV Usage Guide

This guide keeps the detailed operating notes for KohdaLab IV. For first-time machine setup, see [Initial setup](initial_setup.md).
...
詳細仕様は [iv_measurement_spec.md](iv_measurement_spec.md) を参照してください。
...
See [iv_measurement_spec.md](iv_measurement_spec.md) for the full
...
Use [windows_setup.md](windows_setup.md) when preparing a Windows
instrument PC.
